...
const (
	...
	EIP_712_DOMAIN string = "EIP712Domain"
...
const CIAO_ABI string = `[
    ...
    "inputs": [
      {
        "indexed": false,
        "internalType": "address",
        "name": "blastGasRecipient",
        "type": "address"
      }
    ],
    "name": "BlastGasRecipientChanged",
    "type": "event"
  },
  {
    "anonymous": false,
    ...
    "inputs": [
      {
        "indexed": false,
        "internalType": "address",
        "name": "blastYieldRecipient",
        "type": "address"
      }
    ],
    "name": "BlastYieldRecipientChanged",
    "type": "event"
  },
  {
    "anonymous": false,
    ...
    "inputs": [
      {
        "indexed": false,
        "internalType": "bool",
        "name": "requiresDispatchCall",
        "type": "bool"
      }
    ],
    "name": "RequiresDispatchCallSet",
    "type": "event"
  },
  {
    "inputs": [],
  ...
  {
    "inputs": [],
    "name": "addressManifest",
    "outputs": [
      {
        "internalType": "contract IAddressManifest",
        "name": "",
        "type": "address"
      }
    ],
  ...
  },
  {
    ...
    "name": "assetAtIndexInSubAccountAssetSet",
    "outputs": [
      {
        "internalType": "address",
        "name": "",
  ...
  },
  {
    "inputs": [
      {
        "internalType": "address",
        "name": "_addressManifest",
        "type": "address"
      },
      {
        "internalType": "address",
        "name": "_coreCollateralAddress",
        "type": "address"
      },
      {
        "internalType": "address",
      ...
      {
        "internalType": "address",
        "name": "_usdbRebateAddress",
        "type": "address"
      },
      {
        "internalType": "address",
        "name": "_wethRebateAddress",
        "type": "address"
      },
      {
        "internalType": "address",
  ...
  },
  {
    ...
    "name": "isAssetInSubAccountAssetSet",
    "outputs": [
      {
        "internalType": "bool",
        "name": "",
  ...
  },
  {
    "inputs": [
      {
        "internalType": "bool",
        "name": "_requiresDispatchCall",
        "type": "bool"
      }
    ],
    "name": "setRequiresDispatchCall",
    "outputs": [],
    "stateMutability": "nonpayable",
    "type": "function"
  },
  {
    "inputs": [
      ...
      {
        "internalType": "int256",
        "name": "coreCollateralQuantity",
        "type": "int256"
      }
    ],
    "name": "settleCoreCollateral",
    "outputs": [],
    "stateMutability": "nonpayable",
    "type": "function"
  },
  ...
  },
  {
    "inputs": [
      {
        "internalType": "address",
        "name": "takerSubAccount",
        "type": "address"
      },
      {
        "internalType": "address",
        "name": "makerSubAccount",
        "type": "address"
      },
      {
        "internalType": "uint256",
